...
inicjuj_czas();
  ...
  for(i=0;i<1000;i++)
  {
    ...
    //zmiana1 - ma dzialac jak fork
    //pid = clone( &funkcja_watku, (void *) stos+ROZMIAR_STOSU, SIGCHLD, 0 );
    //zmiana2 - brak wspoldzielenia systemu plików
    //ulimit -s
    //8192
    //pid = clone( &funkcja_watku, (void *) stos+ROZMIAR_STOSU, CLONE_VM | CLONE_FILES | CLONE_SIGHAND | CLONE_VM, 0 );
